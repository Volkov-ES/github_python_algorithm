...
КОД НЕ РАБОТАЕТ - НЕ ЗНАЮ КАК ИСПРАВИТЬ
ОШИБКА
  File "D:\Info\Yevgeniy\GeekBrains\Алгоритмы Python\HW_1\HW_1.5.py", line 70, in <module>
    plates.push_in('Plate1')
AttributeError: 'PlateStackClass' object has no attribute 'push_in'
"""
...
class PlateStackClass:
    def __init__(self, max_size):
        ...
        def push_in(self, el):
            ...
            если размер стопки равен пороговому значению, то создаётся новая стопка и туда кладётся значение."""
        ...
        def pop_out(self):
            """Берем тарелку из крайней стопки, если она пустая, то удаляем её."""
